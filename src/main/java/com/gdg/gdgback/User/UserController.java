...
public class UserController {
    ...
    @PostMapping
    public ResponseEntity<java.lang.String> createUser(@Valid @RequestBody UserCreateRequestDto userCreateRequestDto) throws IllegalArgumentException {
        userService.createUser(userCreateRequestDto);
        return ResponseEntity.ok("회원가입 되었습니다.");
    }
    @PostMapping("/delete")
    public ResponseEntity<String> deleteUser(@Valid @RequestBody UserDeleteRequestDto deleteRequestDto) throws IllegalArgumentException {
